#!/bin/bash
#SBATCH --job-name="babel_coord_resume"
...
# ---------------------------------------------------------------------------
# Resume BABEL coordinated attacker training from the latest checkpoint.
# Update CHECKPOINT below to the most recent .zip in the checkpoints/ dir.
#
# Usage:   sbatch job_scripts/train_learned_byzantine_coordinated_60M_resume_ditet.sh
# Output:  /itet-stor/arbaur/net_scratch/out/models/learned_byzantine/29_04_2byz_coordinated_60M/
# ---------------------------------------------------------------------------
...
CHECKPOINT="${OUTPUT_DIR}/checkpoints/byz_agent_23999472_steps.zip"
...
echo ""
echo "=== Resuming BABEL coordinated attacker (target: 60M steps) ==="
