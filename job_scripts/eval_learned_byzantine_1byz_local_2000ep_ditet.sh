...
# ---------------------------------------------------------------------------
# Evaluate the BORA 1-byz learned attacker (local obs scope) for 2000 episodes
# on the D-ITET cluster. Output goes to /scratch/arbaur/.
#
# Usage:   sbatch job_scripts/eval_learned_byzantine_1byz_local_2000ep_ditet.sh
# Requires: ~/resilient-backbone/out/models/learned_byzantine/29_04_1byz_local/byz_agent.zip
#           ~/resilient-backbone/out/evaluations/29_04_jammer_2byz_v3_mag4.0/no_byzantine/
# ---------------------------------------------------------------------------
...
N_EPS=2000
EP_LEN=2000
EXP_NAME="29_04_learned_1byz_local_2000ep"
...
echo "=== Evaluating BORA 1-byz learned attacker (2000 episodes) ==="
...
echo ""
echo "=== Linking no_byzantine baseline (12.79 Mbit/s reference) ==="
